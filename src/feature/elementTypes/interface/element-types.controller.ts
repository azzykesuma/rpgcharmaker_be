...
export class ElementTypesController {
  ...
  async create(req: Request, res: Response): Promise<void> {
    try {
      ...
      const existingElementTypes = await this.elementTypesService.findByName(
        elementName,
      );
      ...
      const elementTypes = await this.elementTypesService.create({
        element_types_name,
      });
      handleResponse(res, {
        data: elementTypes,
  ...
  async findByName(req: Request, res: Response): Promise<void> {
    ...
    const elementTypes = await this.elementTypesService.findByName(
      element_types_name,
    );
    handleResponse(res, {
      data: elementTypes,
